  ...
  create: landlordProcedure
    .input(
      z.object({
        ...
        applySzj: z.boolean().optional(),
        szjRate: z.number().min(0).max(100).optional(),
        szjCostRate: z.number().min(0).max(100).optional(),
        buildingArea: z.number().positive().optional(),
        landArea: z.number().positive().optional(),
        purchasePrice: z.number().optional(),
        purchasePriceCurrency: z.enum(["HUF", "EUR"]).optional(),
