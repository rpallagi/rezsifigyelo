  ...
  return (
    <div className="mt-2 rounded-lg bg-purple-50 dark:bg-purple-950/20 px-2 py-1.5 text-[11px]">
      <div className="flex items-center justify-between gap-2">
        <span className="text-purple-600 dark:text-purple-400">Szamitott:</span>
      ...
      <p className="mt-0.5 text-[10px] text-muted-foreground">
        = Fomero ({data.latestPrimary?.toLocaleString("hu-HU", { maximumFractionDigits: 1 })})
