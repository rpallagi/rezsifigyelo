...
const messages = {
  hu: {
    ...
    billingPage: {
      ...
      providerInfo:
        "Az Agent kulcs az API kapcsolatot állítja be. A vevő adatait a kiválasztott ingatlan és az aktív bérlő alapján állítjuk össze.",
      ...
      providerChecklistBuyer:
        "A rendszer a vevőt először az aktív bérlőből, utána a kapcsolattartóból, végül az ingatlan nevéből állítja össze.",
  ...
  en: {
    ...
    billingPage: {
      ...
      providerInfo:
        "The Agent key only configures the API connection. Buyer details are assembled from the selected property and the active tenant.",
      agentKey: "Agent key",
      ...
      providerChecklistBuyer:
        "Buyer data is built from the active tenant first, then the property contact, and finally the property name.",
      providerChecklistAddress:
