...
const AdminDashboard = () => {
  ...
  const typeBadge = (type: string) => {
    if (type === 'epulet') return <Badge variant="outline" className="bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-emerald-950 dark:text-emerald-400 dark:border-emerald-800 text-xs">{t('common.epulet')}</Badge>;
    if (type === 'telek') return <Badge variant="outline" className="bg-green-50 text-green-700 border-green-200 dark:bg-green-950 dark:text-green-400 dark:border-green-800 text-xs">{t('common.telek')}</Badge>;
